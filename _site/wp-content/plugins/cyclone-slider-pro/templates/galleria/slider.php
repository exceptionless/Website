		...
		<div class="thumbnails-inner">
			...
			<?php foreach($slides as $slide): ?>
				<?php if ($slide['type']=='image') : ?>
					<img src="<?php echo cyclone_slide_image_url($slide['id'], 60, 60, array('current_slide_settings'=>$slide, 'slideshow_settings'=>$slider_settings, 'resize_option'=>'crop') ); ?>" width="60" height="60" alt="<?php echo $slide['img_alt'];?>" title="<?php echo $slide['img_title'];?>" />
				<?php endif; ?>
			<?php endforeach; ?>
			</div>
