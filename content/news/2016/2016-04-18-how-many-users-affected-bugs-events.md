...
date: 2016-04-18
---
**<img loading="lazy" class="alignright size-full wp-image-14327" src="/assets/img/news/users-featured-image.png" alt="exceptionless user tracking" width="260" height="260" data-id="14327" srcset="/assets/users-featured-image.png 260w, /assets/users-featured-image-150x150.png 150w" sizes="(max-width: 260px) 100vw, 260px" />Prioritizing your bug fixes and development time** in general can be a daunting task.
...
<a href="/assets/img/news/dashboard-most-usersv2-edited.png" rel="attachment wp-att-14354"><img loading="lazy" class="aligncenter size-large wp-image-14354" src="/assets/dashboard-most-usersv2-edited-1024x644.png" alt="user event dashboard" width="940" height="591" data-id="14354" srcset="/assets/dashboard-most-usersv2-edited-1024x644.png 1024w, /assets/dashboard-most-usersv2-edited-300x189.png 300w, /assets/dashboard-most-usersv2-edited-768x483.png 768w, /assets/dashboard-most-usersv2-edited.png 1408w" sizes="(max-width: 940px) 100vw, 940px" /></a>
